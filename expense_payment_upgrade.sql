...
-- the date it was paid, the bank reference number when applicable, and an
-- uploaded proof-of-payment file. Mirrors freelance_payments' payment_date/
-- bank_reference columns.
...
ADD COLUMN payment_receipt_path VARCHAR(500) NULL DEFAULT NULL AFTER bank_reference;
